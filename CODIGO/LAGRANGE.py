	...
	for j in range(0,n_col):
		...
		if j >=1:
			for i in range(0, j-1):
			    print("========================")
			    print("U en iter j={}, i={}:".format(j,i))
			    U[i,j] = E[:, i].dot(A[:, j])
			    print(U)
			    print("========================")
			    E[:, j] = E[:, j] -  U[i,j]*E[:, i]
	...
	for col in range(A.shape[1]):
		for row in range(A.shape[0] - 1, -1, -1):
			if row > col:
				...
				Q = np.matmul(G_matrix,Q)
				new_A = np.matmul(G_matrix, new_A)
				# ====================================
				if verbose:
...
def solve_Parlett_Reid(A, b, verbose, pivot="none"):
	#=========================================
	if verbose:
		print("=========================================")
...
def solve_Householder(A, b, verbose):
	#=========================================
	if verbose:
		print("=========================================")
...
def solve_SOR(A, b, x_0, w, epsilon, n_iter, verbose):
	#=========================================
	if verbose:
		print("=========================================")
